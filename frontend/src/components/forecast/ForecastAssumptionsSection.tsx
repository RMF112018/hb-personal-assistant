/* Forecast assumptions capture (first interactive forecast write surface).
 * Operator-entered assumptions persist directly into the v66 managed-DB tables via role-guarded
 * POST/PATCH. Operators create/edit assumptions and create/mark-satisfied required assumptions;
 * lists refetch after each write. Read paths never surface raw_json/run_id.
 *
 * This is the panel-less section so it can be embedded in the Create Forecast modal or wrapped in a
 * standalone panel (ForecastOperatorAssumptionsPanel). */
import { useState } from 'react'
import { useQuery } from '@tanstack/react-query'

import { EmptyState } from '../ui/EmptyState'
import { api } from '../../lib/api'
import { ForecastAdvisoryStrip, ForecastTable, ForecastTd, ForecastTh } from './ForecastPrimitives'
...
export function ForecastAssumptionsSection({ project }: { project: string }) {
