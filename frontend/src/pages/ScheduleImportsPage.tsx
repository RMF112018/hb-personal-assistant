      ...
      <div className="forecast-panel p-4 space-y-4">
        ...
        {committed ? (
          <div className="rounded border border-[var(--hb-border)] p-3 text-sm space-y-2">
            ...
            <p className="text-[var(--hb-muted)]">
              DCMA quality evaluation{' '}
              {String(committed.quality_evaluation_status ?? 'queued')}
              {committed.evaluation_run_id ? ` (${String(committed.evaluation_run_id)})` : ''}.
            </p>
            <div className="flex flex-wrap gap-3">
              ...
              <ScheduleActionLink
                to={`/schedules/quality?version=${encodeURIComponent(String(committed.schedule_version_key))}`}
              >
