...
_FAMILY_PROJECTION: Dict[str, Dict[str, Any]] = {
    "foundation": {"entities": [], "edges": False, "action_signals": False,
                   "text_intelligence": False, "financial_tables": []},
    "rfis": {"entities": ["people", "company"], "edges": True, "action_signals": True,
             "text_intelligence": True, "financial_tables": []},
    "submittals": {"entities": ["people", "company", "custom_fields"], "edges": True,
                   "action_signals": True, "text_intelligence": True, "financial_tables": []},
    "observations": {"entities": ["people", "custom_fields"], "edges": True,
                     "action_signals": True, "text_intelligence": True, "financial_tables": []},
    "meetings": {"entities": ["people", "attachments"], "edges": True, "action_signals": True,
                 "text_intelligence": True, "financial_tables": []},
    "daily_logs": {"entities": ["people", "company", "location", "attachments", "custom_fields"],
                   "edges": True, "action_signals": True, "text_intelligence": True,
                   "financial_tables": []},
    "punch_items": {"entities": ["people", "custom_fields", "attachments"], "edges": True,
                    "action_signals": True, "text_intelligence": True, "financial_tables": []},
    "schedules": {"entities": [], "edges": True, "action_signals": True,
                  "text_intelligence": False, "financial_tables": []},
    "inspections": {"entities": ["people"], "edges": True, "action_signals": True,
                    "text_intelligence": True, "financial_tables": []},
    "owner_contracts": {"entities": ["company"], "edges": True, "action_signals": True,
                        "text_intelligence": False,
                        "financial_tables": ["procore_financial_contracts",
                                             "procore_financial_line_items",
                                             "procore_financial_amount_facts"]},
    "owner_billing": {"entities": [], "edges": True, "action_signals": True,
                      "text_intelligence": False,
                      "financial_tables": ["procore_financial_amount_facts"]},
    "commitments": {"entities": ["company"], "edges": True, "action_signals": True,
                    "text_intelligence": False,
                    "financial_tables": ["procore_financial_contracts",
                                         "procore_financial_line_items",
                                         "procore_financial_compliance_documents",
                                         "procore_financial_amount_facts"]},
    "purchase_orders": {"entities": ["company"], "edges": True, "action_signals": True,
                        "text_intelligence": False,
                        "financial_tables": ["procore_financial_contracts",
                                             "procore_financial_line_items",
                                             "procore_financial_amount_facts"]},
    "subcontractor_invoices": {"entities": ["company"], "edges": True, "action_signals": True,
                               "text_intelligence": False,
                               "financial_tables": ["procore_financial_subcontractor_invoices",
                                                    "procore_financial_invoice_items",
                                                    "procore_financial_amount_facts"]},
    "billing": {"entities": [], "edges": True, "action_signals": True, "text_intelligence": False,
                "financial_tables": ["procore_financial_billing_periods"]},
    "budget": {"entities": [], "edges": True, "action_signals": True, "text_intelligence": False,
               "financial_tables": ["procore_financial_budget_views",
                                    "procore_financial_budget_rows",
                                    "procore_financial_budget_changes",
                                    "procore_financial_amount_facts"]},
    "change_management": {"entities": ["company"], "edges": True, "action_signals": True,
                          "text_intelligence": False,
                          "financial_tables": ["procore_financial_rfqs",
                                               "procore_financial_change_events",
                                               "procore_financial_amount_facts"]},
}


def _coverage_for_payload(endpoint_id: str, payloads_dir: Path, now_utc: str) -> Optional[Dict[str, Any]]:
