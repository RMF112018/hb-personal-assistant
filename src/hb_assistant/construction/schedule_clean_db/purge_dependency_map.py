...
SUPPLEMENTAL_DELETE_EDGES: list[tuple[str, str]] = [
    ...
    ("schedule_baseline_activity_codes", "schedule_baseline_projects"),
    ("schedule_baseline_udfs", "schedule_baseline_projects"),
    ("schedule_baseline_wbs", "schedule_baseline_projects"),
    ("schedule_baseline_activities", "schedule_baseline_projects"),
    ("schedule_baseline_relationships", "schedule_baseline_projects"),
...
PURGE_TABLE_STRATEGIES: dict[str, str] = {
    ...
    "schedule_version_diffs": "by_project_key",
    "schedule_version_diff_facts": "by_project_key",
    "schedule_version_diff_detail_facts": "by_project_key",
    "schedule_version_diff_impact_rollups": "by_project_key",
    "schedule_baseline_activity_codes": "by_baseline_project_key",
    "schedule_baseline_udfs": "by_baseline_project_key",
    "schedule_baseline_wbs": "by_baseline_project_key",
    "schedule_baseline_activities": "by_baseline_project_key",
    "schedule_baseline_relationships": "by_baseline_project_key",
    "schedule_baseline_activity_crosswalk": "by_baseline_project_key",
    "schedule_baseline_health_facts": "by_baseline_project_key",
}
