...
def test_latest_schema_version_is_at_least_108() -> None:
    ...
    # added the review-aware intelligence-projection tables; v107 (N8C-11) added the research-packet /
    # citation-manifest / answer-context tables; v108 (N8C-14) added the citation-safe answer-draft tables;
    # v109 (N8C-18) added the feedback / review-loop tables. Head-agnostic — advances with later phases.
