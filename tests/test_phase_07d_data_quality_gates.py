...
def test_table_inventory_unchanged() -> None:
    assert build_table_inventory_report()["contract_table_count"] == 439  # Phase 4: +8 v61 external-forecast tables (was 399; V62 +13 schedule tables; V63 +10 run-output tables)
