...
_LOCATION = {"id": 15504, "name": "North Building>First Floor", "node_name": "Closet", "parent_id": 788866}
_VENDOR = {"id": 161072, "name": "Synthetic Architecture"}
_SEGMENT = {"id": 123456, "name": "Morning Shift", "description": "synthetic segment description text", "deleted": False}
_ATTACH = [{
    "id": 42, "name": "string", "filename": "synthetic-file.jpg", "content_type": "image/jpeg",
...
def _assert_no_pii_leak(record):
    ...
    for needle in _PII_STRINGS + _FREETEXT_STRINGS + ["synthetic secret custom value", "synthetic segment description"]:
...
def test_weather_scalars_signals_and_no_leak():
    raw = {
        "id": 20160101, "date": "2016-05-19", "datetime": "2016-05-19T12:00:00Z",
        "average": 50, "sky": "Clear", "ground": "Dry", "wind": "Calm",
        "temperature": "Hot", "precipitation": True, "is_weather_delay": 1,
        "calamity": "Fire", "comments": _FREETEXT_STRINGS[0], "created_by": _PERSON,
        "vendor": _VENDOR, "location": _LOCATION, "daily_log_segment": _SEGMENT,
        "attachments": _ATTACH, "updated_at": "2012-10-24T21:39:40Z",
    }
...
def test_manpower_hashes_all_people_and_types_custom_fields():
    raw = {
        "id": 333675, "date": "2016-05-19", "man_hours": "32.0", "num_workers": 4,
        "num_hours": "8.0", "status": "pending", "notes": _FREETEXT_STRINGS[1],
        "vendor": _VENDOR, "cost_code": {"id": 12345, "name": "Earthwork"},
        "trade": {"id": 999, "name": "09 - acoustical panels"},
        "user": {"id": 324, "login": "synthetic-contact@example.test", "name": "Synthetic Carl"},
        "contact": {"id": 1128828, "email": "synthetic-contact@example.test",
                    "mobile_phone": "(503) 555-0100", "name": "Synthetic Carl", "job_title": "Engineer"},
        "created_by": _PERSON, "location": _LOCATION, "attachments": _ATTACH,
        "custom_fields": _CUSTOM_FIELDS, "permissions": {"can_update": True, "can_delete": False},
...
def test_notes_review_required_and_comment_hashed():
    raw = {
        "id": 333675, "comment": _FREETEXT_STRINGS[0], "date": "2016-05-19",
        "daily_log_header_id": 151335, "is_issue_day": True, "status": "pending",
        "created_by": _PERSON, "created_by_collaborator": True, "vendor": _VENDOR,
        "location": _LOCATION, "daily_log_segment": _SEGMENT, "attachments": _ATTACH,
        "updated_at": "2012-10-24T21:39:40Z",
    }
...
@pytest.mark.parametrize(
    ...
    [
        (dll.normalize_daily_log_delay, "daily-log-delays-review-routed",
         {"id": 1, "delay_type": "weather", "duration": 5, "comments": _FREETEXT_STRINGS[0],
          "created_by": _PERSON, "location": _LOCATION, "attachments": _ATTACH}, "delay"),
        (dll.normalize_daily_log_accident, "daily-log-accident-review-routed",
         {"id": 2, "comments": _FREETEXT_STRINGS[0], "involved_name": "Synthetic Involved Person",
          "involved_company": "Synthetic Industries", "created_by": _PERSON,
          "location": _LOCATION, "attachments": _ATTACH}, "safety"),
        (dll.normalize_daily_log_safety_violation, "daily-log-safety-violation-review-routed",
         {"id": 3, "comments": _FREETEXT_STRINGS[0], "safety_notice": _FREETEXT_STRINGS[3],
          "compliance_due": "2016-06-20", "issued_to": "Synthetic Industries", "subject": "hard hats",
          "created_by": _PERSON, "location": _LOCATION, "attachments": _ATTACH}, "safety"),
    ],
)
...
def test_inspection_safety_detection_and_inspector_hashed():
    raw = {
        "id": 333675, "area": "Level 5", "comments": _FREETEXT_STRINGS[0],
        "inspecting_entity": "Safety", "inspection_type": "Safety",
        "inspector_name": "Synthetic Inspector", "created_by": _PERSON,
        "location": _LOCATION, "vendor": _VENDOR, "attachments": _ATTACH,
    }
...
def test_inspection_non_safety_is_medium():
    raw = {"id": 1, "inspection_type": "General", "inspecting_entity": "QA",
           "inspector_name": "Synthetic Inspector", "created_by": _PERSON}
    rec = _norm(dll.normalize_daily_log_inspection, "daily-log-inspections", raw)
...
def test_visitor_subject_pii_hashed():
    raw = {
        "id": 333675, "begin_hour": 12, "end_hour": 14, "status": "pending",
        "details": _FREETEXT_STRINGS[2], "subject": "Synthetic Visitor (Glass Co.)",
        "created_by": _PERSON, "vendor": _VENDOR, "location": _LOCATION,
        "custom_fields": _CUSTOM_FIELDS, "permissions": {"can_update": True, "can_delete": False},
    }
...
def test_dumpster_structured_and_edges():
    raw = {"id": 333675, "quantity_delivered": 5, "quantity_removed": 2,
           "comments": _FREETEXT_STRINGS[0], "created_by": _PERSON, "vendor": _VENDOR,
           "location": _LOCATION, "daily_log_segment": _SEGMENT, "attachments": _ATTACH}
...
def test_dcr_preserves_hour_fields_and_hashes_notes():
    raw = {"id": 333675, "status": "pending", "apprentice_hours": "5.0", "foreman_hours": "5.0",
           "number_of_apprentice_workers": 4, "notes": _FREETEXT_STRINGS[1], "created_by": _PERSON,
           "vendor": _VENDOR, "trade": {"id": 999, "name": "09 - acoustical panels"},
           "location": _LOCATION, "custom_fields": _CUSTOM_FIELDS,
