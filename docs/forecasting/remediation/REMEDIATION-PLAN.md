...
| P4 | Multi-project generalization (remove tropical-only guards) | 4 | production_blocker | in-review | (pending) | `docs/evidence/forecast-remediation/P4-multi-project-20260623T101104Z/` | 2026-06-23 | — |
