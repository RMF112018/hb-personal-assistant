...
| P2b | Operator-assumption dollar value-overrides (output projection) | 2 | high | in-review | (PR pending) | `docs/evidence/forecast-remediation/P2b-value-overrides-20260623T162613Z/` | 2026-06-23 | — |
