...
| P3 | DB-native model input accessors (reduce package-as-source) | 3 | high | in-review | (PR pending) | `docs/evidence/forecast-remediation/P3-db-native-inputs-20260623T193155Z/` | 2026-06-23 | — |
