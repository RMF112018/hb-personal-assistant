# Prompt 04 — CLI List, Show, and Summary

## Objective

Implement read-only Phase 10A candidate review CLI commands.
...
Include filters, redacted output, source refs in show, and `--db` support.
