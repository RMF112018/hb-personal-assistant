# Email Commitment Candidate Extraction

## Objective

Extract commitments made by the user and others, due dates, waiting states, and source-linked review candidates.
...
```text
Phase 10 08: Email Commitment Candidate Extraction
