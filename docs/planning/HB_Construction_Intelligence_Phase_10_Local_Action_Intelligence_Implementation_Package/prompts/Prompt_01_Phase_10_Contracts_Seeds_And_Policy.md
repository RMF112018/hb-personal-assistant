# Phase 10 Contracts Seeds and Policy

## Objective

Add Phase 10 JSON contracts and YAML seed policy files for local model profiles, jobs, candidates, Obsidian, MCP packets, and frontend review queue.
...
```text
Phase 10 01: Phase 10 Contracts Seeds and Policy
