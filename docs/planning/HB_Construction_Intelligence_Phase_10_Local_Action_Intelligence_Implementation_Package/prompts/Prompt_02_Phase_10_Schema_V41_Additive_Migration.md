# Phase 10 Schema V41 Additive Migration

## Objective

Implement additive SQLite schema for local model profiles, AI jobs, candidates, follow-ups, relationships, Obsidian index, and Claude packets.
...
```text
Phase 10 02: Phase 10 Schema V41 Additive Migration
