...
Classify email/read-model items into action required, FYI, waiting, project update, commercial/cost, schedule, contract/legal, safety, RFI/submittal, unknown.
...
```text
Phase 10 09: Inbox Classification and Prioritization
