# Email Task Candidate Extraction

## Objective

Extract reviewable task candidates from metadata-safe email thread summaries/read models using deterministic signals plus local model structured output.
...
```text
Phase 10 07: Email Task Candidate Extraction
