# Backend API Action Intelligence Surfaces

## Objective

Add FastAPI/local analytics endpoints for My Dashboard, Review Queue, follow-ups, Daily Brief candidates, Obsidian suggestions, and MCP packet suggestions.
...
```text
Phase 10 20: Backend API Action Intelligence Surfaces
