...
Expose safe MCP resources/tools/prompts for packets, source-linked context, follow-up queues, and Obsidian outputs.
...
```text
Phase 10 19: MCP Resources Tools and Prompts
