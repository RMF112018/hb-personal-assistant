# Obsidian Vault Status and Index

## Objective

Implement vault status and read-only vault index over allowlisted folders, notes, frontmatter, tags, links, and managed markers.
...
```text
Phase 10 15: Obsidian Vault Status and Index
