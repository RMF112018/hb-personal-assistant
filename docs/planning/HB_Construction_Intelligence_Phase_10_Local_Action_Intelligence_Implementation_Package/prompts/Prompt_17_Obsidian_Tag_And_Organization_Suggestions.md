# Obsidian Tag and Organization Suggestions

## Objective

Generate reviewable tag/folder/frontmatter suggestions, not automatic broad note rewrites.
...
```text
Phase 10 17: Obsidian Tag and Organization Suggestions
