# Action Candidate Output Contracts and Fixture Runner

## Objective

Implement action candidate Pydantic models, JSON schemas, fixture runner, and schema validation failure handling.
...
```text
Phase 10 06: Action Candidate Output Contracts and Fixture Runner
