...
Generate cross-source relationship candidates between email, calendar, Procore, project, Daily Brief, Obsidian, and MCP packet records.
...
```text
Phase 10 11: Relationship Candidate Engine
