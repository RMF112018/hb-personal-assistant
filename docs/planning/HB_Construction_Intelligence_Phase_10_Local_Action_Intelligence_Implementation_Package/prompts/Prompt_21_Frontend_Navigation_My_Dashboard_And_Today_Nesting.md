# Frontend Navigation My Dashboard and Today Nesting

## Objective

Retitle My Items to My Dashboard, make it the first nav item, nest Today as primary landing, and remove duplicate page headers.
...
- Do not expose internal run IDs, prompt IDs, schema tables, or evidence paths outside Admin/Data Health.
- Include empty, loading, stale, and degraded states.
- All action controls must call local backend APIs only.
...
```text
Phase 10 21: Frontend Navigation My Dashboard and Today Nesting
