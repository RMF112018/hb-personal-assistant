...
Implement golden fixtures, precision/recall metrics, acceptance-rate metrics, model latency, schema failure, and source-ref completeness reporting.
...
```text
Phase 10 25: Evaluation Fixtures and Metrics
