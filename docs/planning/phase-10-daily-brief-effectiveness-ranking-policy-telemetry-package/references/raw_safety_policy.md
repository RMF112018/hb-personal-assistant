...
Reuse the repo's category-only scanner, currently generation-time anchored at `model_eval_metrics.py::scan_text_for_forbidden`, or the local repo-truth equivalent. Scanner findings in evidence must be category codes only.
