...
Explicitly confirm no Graph/Procore writeback, metadata-only status, no live external reads from status page, local refresh no live clients, and live refresh fail-closed behavior.
