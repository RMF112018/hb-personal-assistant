...
```json
{
  "source_families": {
    "agent_receipts": {
      "configured_status": "present_in_schema",
      ...
      "record_count": 58,
      "review_tables": [],
      "source_reference_table_count": 18
    },
    "automation": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "source_reference_table_count": 4
    },
    "calendar": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "known_gaps_in_lineage": [],
      "project_linked_table_count": 7,
      "receipt_tables": [],
      "record_count": 56590,
      "review_tables": [],
      "source_reference_table_count": 13
    },
    "daily_brief": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "record_count": 9,
      "review_tables": [],
      "source_reference_table_count": 9
    },
    "financial": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "known_gaps_in_lineage": [],
      "project_linked_table_count": 24,
      "receipt_tables": [],
      "record_count": 169401,
      "review_tables": [
        "second_brain_financial_review_required_items"
      ],
      "source_reference_table_count": 20
    },
    "local_files": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [],
      ...
      "known_gaps_in_lineage": [],
      "project_linked_table_count": 2,
      "receipt_tables": [],
      "record_count": 38,
      "review_tables": [],
      "source_reference_table_count": 2
    },
    "mcp": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "source_reference_table_count": 10
    },
    "memory": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "source_reference_table_count": 3
    },
    "microsoft_graph": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
    ...
    "procore": {
      ...
      "known_gaps_in_lineage": [],
      "project_linked_table_count": 34,
      "receipt_tables": [],
      "record_count": 295248,
      "review_tables": [],
      "source_reference_table_count": 28
    },
    "research_packet": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "record_count": 0,
      "review_tables": [],
      "source_reference_table_count": 1
    },
    "review_queue": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
      ...
      "source_reference_table_count": 6
    },
    "sharepoint_onedrive": {
      "configured_status": "present_in_schema",
      "derived_read_model_tables": [
