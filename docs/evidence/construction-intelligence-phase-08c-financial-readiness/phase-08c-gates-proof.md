...
- Schema version: 42 (expected >= 35)
- Status counts: {'pass': 6, 'warning': 5, 'fail_blocking': 11, 'deferred_not_blocking': 0}
- Required fields covered: true
- Readiness overstated: true
- Missing required evidence: ['second_brain_financial_fact_normalization_runs', 'second_brain_financial_amount_facts_normalized', 'second_brain_financial_currency_completeness_snapshots', 'second_brain_financial_wbs_cost_code_snapshots', 'second_brain_financial_source_coverage_snapshots', 'second_brain_financial_exposure_summary_items', 'second_brain_financial_forecast_readiness_runs', 'second_brain_financial_review_required_items', 'second_brain_financial_readiness_agent_runs', 'second_brain_phase_08c_validation_runs']
...
| second_brain_financial_fact_normalization_runs | fail_blocking |
| second_brain_financial_amount_facts_normalized | fail_blocking |
| second_brain_financial_currency_completeness_snapshots | fail_blocking |
| second_brain_financial_wbs_cost_code_snapshots | fail_blocking |
| second_brain_financial_source_coverage_snapshots | fail_blocking |
| second_brain_financial_exposure_summary_items | fail_blocking |
| second_brain_financial_forecast_readiness_runs | fail_blocking |
| second_brain_financial_review_required_items | fail_blocking |
| second_brain_financial_readiness_agent_runs | fail_blocking |
| second_brain_phase_08c_validation_runs | fail_blocking |
| amount_normalization | pass |
| currency_completeness | warning |
| wbs_cost_code_completeness | warning |
| source_coverage | warning |
| exposure_marts | pass |
| readiness_agent | warning |
| forecast_readiness | warning |
| review_required_policy | pass |
| cli_operator_status | pass |
| no_writeback_no_raw_financial_output | fail_blocking |
...
Generated: 2026-06-07T23:02:19.203347Z
