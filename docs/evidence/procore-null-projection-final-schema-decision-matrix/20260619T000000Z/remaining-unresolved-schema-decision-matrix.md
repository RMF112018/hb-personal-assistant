...
- `custom_field_evidence_needed`: `3`.
...
| Custom-field object/container fields needing more evidence | 3 | `procore_ep_purchase_order_contracts.custom_fields_custom_field_214072_value`, `custom_fields_custom_field_214078_value`, `custom_fields_custom_field_214087_value` | Patch 3 marked these custom-field containers as needing additional body-free custom-field source evidence. Patch 4 intentionally excluded them. | Do not deprecate or decompose until custom-field metadata/source evidence is reviewed. | `needs_additional_source_sample`. |
