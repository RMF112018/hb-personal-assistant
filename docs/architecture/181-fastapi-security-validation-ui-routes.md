...
- lib/api.ts: thin typed fetch helpers (getToday*, getProjects*, getMyItems*, getAdmin* + 6, getDailyBriefStatus/Latest + configure/generate/validate/detect, and prior connection/onboard/auth helpers).
