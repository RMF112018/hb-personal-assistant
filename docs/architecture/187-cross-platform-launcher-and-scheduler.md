...
The `launcher <env> --open` flow that auto-opens the frontend UI (browser/pywebview),
config-driven frontend URL resolution, and browser-mode close-policy semantics are
documented in [188 — Launcher Open Frontend](188-launcher-open-frontend.md).
