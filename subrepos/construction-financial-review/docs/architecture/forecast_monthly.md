...
| `monthly_reconcile.py` | Blends the three vectors (reported source shares), applies day-aware partial scaling, allocates month costs that tie exactly to CTC/final, detects the overrun month. |
