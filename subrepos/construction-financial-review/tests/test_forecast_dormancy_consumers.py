...
def test_intelligence_consumer_history_cannot_reinflate_dormant():
    f, rec, floor, integ_final, integ_ctc = intelligence_consumer.build("tropical", KEY, _entry(_dormant()), _sc())
...
def test_value_asserting_control_revives_dormant_in_consumers():
    ...
    f, rec, floor, integ_final, integ_ctc = intelligence_consumer.build("tropical", KEY, entry, _sc())
