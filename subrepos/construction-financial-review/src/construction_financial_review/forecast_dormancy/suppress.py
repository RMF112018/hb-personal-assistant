...
def audit_row(decision: dict, before: dict) -> "OrderedDict":
    ...
    return OrderedDict([
        ...
        ("prior_activity_detected", decision.get("prior_activity_detected")),
        ("recent_zero_run_detected", decision.get("recent_zero_run_detected")),
        ("staffing_or_general_conditions_code", decision.get("staffing_or_general_conditions_code")),
        ("staffing_plan_future_assignment", decision.get("staffing_plan_future_assignment")),
        ("non_staffing_suppression_candidate", decision.get("non_staffing_suppression_candidate")),
        ("zero_run_threshold_used", decision.get("zero_run_threshold_used")),
